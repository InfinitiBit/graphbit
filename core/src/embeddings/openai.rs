...
use super::providers::{EmbeddingConfig, EmbeddingProvider};
use super::{EmbeddingInput, EmbeddingProviderTrait, EmbeddingRequest, EmbeddingResponse, EmbeddingUsage};
...
impl EmbeddingProviderTrait for OpenAIEmbeddingProvider {
    ...
    async fn get_embedding_dimensions(&self) -> GraphBitResult<usize> {
        ...
        match self.config.model.as_str() {
            "text-embedding-ada-002" | "text-embedding-3-small" => Ok(1536),
