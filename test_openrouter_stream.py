#!/usr/bin/env python3
"""Test OpenRouter streaming implementation"""
...
async def test_openrouter_stream_async_iteration():
    """Test OpenRouter streaming with async iteration"""
    print("=" * 60)
    print("TEST 1: OpenRouter Streaming - Async Iteration")
    print("=" * 60)

    api_key = os.environ.get("OPENROUTER_API_KEY")
    if not api_key:
        print("⚠️  OPENROUTER_API_KEY not set. Skipping test.")
        return None

    config = LlmConfig.openrouter(api_key, "openai/gpt-4o-mini")
...
async def test_openrouter_stream_streaming_response():
    """Test OpenRouter streaming with streaming_response() method"""
    print("\n" + "=" * 60)
    print("TEST 2: OpenRouter Streaming - streaming_response()")
    print("=" * 60)
...
async def test_openrouter_stream_longer_response():
    """Test OpenRouter streaming with a longer response and timing analysis"""
    print("\n" + "=" * 60)
    print("TEST 3: OpenRouter Streaming - Longer Response + Timing")
    print("=" * 60)
...
async def main():
    """Run all tests"""
    print("\n🚀 Testing OpenRouter Streaming Implementation")
    print("=" * 60)
    print("NOTE: Requires OPENROUTER_API_KEY in .env file")
    ...
    results.append(("Async iteration", await test_openrouter_stream_async_iteration()))

    # Test 2: streaming_response()
    results.append(("streaming_response()", await test_openrouter_stream_streaming_response()))

    # Test 3: Longer response with timing
    results.append(("Longer response + timing", await test_openrouter_stream_longer_response()))
