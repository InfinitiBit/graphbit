#!/usr/bin/env python3
"""Test AI21 streaming implementation"""
...
async def test_ai21_stream_async_iteration():
    """Test AI21 streaming with async iteration"""
    print("=" * 60)
    print("TEST 1: AI21 Streaming - Async Iteration")
    print("=" * 60)

    api_key = os.environ.get("AI21_API_KEY")
    if not api_key:
        print("⚠️  AI21_API_KEY not set. Skipping test.")
        return None

    config = LlmConfig.ai21(api_key, "jamba-large")
...
async def test_ai21_stream_streaming_response():
    """Test AI21 streaming with streaming_response() method"""
    print("\n" + "=" * 60)
    print("TEST 2: AI21 Streaming - streaming_response()")
    print("=" * 60)
    ...
    config = LlmConfig.ai21(api_key, "jamba-mini")
    client = LlmClient(config, debug=True)
...
async def test_ai21_stream_longer_response():
    """Test AI21 streaming with a longer response and timing analysis"""
    print("\n" + "=" * 60)
    print("TEST 3: AI21 Streaming - Longer Response + Timing")
    print("=" * 60)
...
async def main():
    """Run all tests"""
    print("\n🚀 Testing AI21 Streaming Implementation")
    print("=" * 60)
    print("NOTE: Requires AI21_API_KEY in .env file")
    print("      Using model: jamba-mini")
    print("      If you get 'Access denied for this feature', check your")
    print("      AI21 API plan — the key may not have chat/completions access.")
    print("=" * 60)

    results = []

    # Test 1: Async iteration
    results.append(("Async iteration", await test_ai21_stream_async_iteration()))

    # Test 2: streaming_response()
    results.append(("streaming_response()", await test_ai21_stream_streaming_response()))

    # Test 3: Longer response with timing
    results.append(("Longer response + timing", await test_ai21_stream_longer_response()))
