#!/usr/bin/env python3
"""Test Ollama streaming implementation"""
...
async def test_ollama_stream_async_iteration():
    """Test Ollama streaming with async iteration"""
    print("=" * 60)
    print("TEST 1: Ollama Streaming - Async Iteration")
    print("=" * 60)

    config = LlmConfig.ollama("llama3.1")
...
async def test_ollama_stream_streaming_response():
    """Test Ollama streaming with streaming_response() method"""
    print("\n" + "=" * 60)
    print("TEST 2: Ollama Streaming - streaming_response()")
    print("=" * 60)
...
async def test_ollama_stream_longer_response():
    """Test Ollama streaming with a longer response and timing analysis"""
    print("\n" + "=" * 60)
    print("TEST 3: Ollama Streaming - Longer Response + Timing")
    print("=" * 60)
...
async def main():
    """Run all tests"""
    print("\n🚀 Testing Ollama Streaming Implementation")
    print("=" * 60)
    print("NOTE: Ollama must be running locally (http://localhost:11434)")
    print("      with the 'llama3.1' model available.")
    ...
    results.append(("Async iteration", await test_ollama_stream_async_iteration()))

    # Test 2: streaming_response()
    results.append(("streaming_response()", await test_ollama_stream_streaming_response()))

    # Test 3: Longer response with timing
    results.append(("Longer response + timing", await test_ollama_stream_longer_response()))
