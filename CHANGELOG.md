...
- **[Feature]** Added chatbot development example ([#38](https://github.com/InfinitiBit/graphbit/pull/38)) — *by @tanimahossain-infiniti*  
- **[Feature]** Added textsplitter ([#64](https://github.com/InfinitiBit/graphbit/pull/64)) — *by @yeahia-sarker*  
- **[Feature]** Implemented LLM-GraphBit-Playwright browser automation agent ([#52](https://github.com/InfinitiBit/graphbit/pull/52)) — *by @jj-devhub*  
- **[Feature]** Added deepseek support ([#66](https://github.com/InfinitiBit/graphbit/pull/66)) — *by @yeahia-sarker*  
- **[Feature]** Added perplexity support ([#67](https://github.com/InfinitiBit/graphbit/pull/67)) — *by @yeahia-sarker*  
- **[Feature]** Added complete MkDocs documentation site using Material theme ([#79](https://github.com/InfinitiBit/graphbit/pull/79)) — *by @jj-devhub*  
- **[Feature]** Rust Core & Python Binding: Agentic Workflow with Dep-Batching and Parent Preamble ([#87](https://github.com/InfinitiBit/graphbit/pull/87)) — *by @jj-devhub*  
- **[Feature]** Docs site ([#83](https://github.com/InfinitiBit/graphbit/pull/83)) — *by @jj-devhub*  

### Bugfixes
- **[Hotfix]** Resolve hook failures and improve security compliance ([#45](https://github.com/InfinitiBit/graphbit/pull/45)) — *by @jj-devhub*  
- **[Hotfix]** Updated `black` and dependency check ([#48](https://github.com/InfinitiBit/graphbit/pull/48)) — *by @yeahia-sarker*  
- **[Bugfix]** Add macOS fallback for `sched_getaffinity` ([#50](https://github.com/InfinitiBit/graphbit/pull/50)) — *by @jj-devhub*  
- **[Bugfix]** Formatted codebase to pass all pre-commit checks ([#49](https://github.com/InfinitiBit/graphbit/pull/49)) — *by @JunaidHossain04*  
- **[Bugfix]** Make GraphBit benchmark CPU affinity logic cross-platform (macOS support, safe fallback) ([#51](https://github.com/InfinitiBit/graphbit/pull/51)) — *by @jj-devhub*  
...
### Features
- **[Feature]** Improved runner and documentation in benchmark ([#29](https://github.com/InfinitiBit/graphbit/pull/29)) — *by @jj-devhub*  
- **[Feature]** Added Dockerization support for benchmark ([#30](https://github.com/InfinitiBit/graphbit/pull/30)) — *by @yeahia-sarker*  
- **[Feature]** Updated volume mount paths for production deployment ([#41](https://github.com/InfinitiBit/graphbit/pull/41)) — *by @jj-devhub*  
- **[Feature]** Centralized and explicitly controlled number of benchmark runs ([#42](https://github.com/InfinitiBit/graphbit/pull/42)) — *by @jj-devhub*  
- **[Feature]** Added Tarpaulin test coverage ([#43](https://github.com/InfinitiBit/graphbit/pull/43)) — *by @yeahia-sarker*  

### Bugfixes
- **[Hotfix]** Added comprehensive Python tests ([#25](https://github.com/InfinitiBit/graphbit/pull/25)) — *by @yeahia-sarker*  
- **[Hotfix]** Improved Rust integration test coverage ([#26](https://github.com/InfinitiBit/graphbit/pull/26)) — *by @yeahia-sarker*  

### Documentation
- **[Documentation]** Updated root README ([#37](https://github.com/InfinitiBit/graphbit/pull/37)) — *by @yeahia-sarker*  
- **[Documentation]** Updated contributing guidelines ([#40](https://github.com/InfinitiBit/graphbit/pull/40)) — *by @yeahia-sarker*  

**Full Changelog**: [v0.2.0...v0.3.0](https://github.com/InfinitiBit/graphbit/compare/v0.2.0...v0.3.0)
